...
//#define VIDEO_INFO_Y		(0)//(VIDEO_LOGO_HEIGHT)
//==hyq end
...
static void *video_logo (void)
{
	...
	sprintf (info, " %s", "Fuzhou University");
	video_drawstring (VIDEO_LOGO_WIDTH, 0, (uchar *)info);
	sprintf (info, " %s", "Name:HuangYinQing");
	video_drawstring (0, 120, (uchar *)info);
	sprintf (info, " %s", "Major:Microelectronics");
	video_drawstring (0, 120+VIDEO_FONT_HEIGHT, (uchar *)info);
	sprintf (info, " %s", "Number:110800836");
	video_drawstring (0, 120+VIDEO_FONT_HEIGHT*2, (uchar *)info);
#if 0
